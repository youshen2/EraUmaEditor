...
class GlobalPage extends ConsumerWidget {
  ...
  static final List<EditorItem> _items = [
    ...
    EditorItem.info("所有难度选项都参考自EraUma注释，如果出现无效值——我也不到啊。"),
    EditorItem(
        label: '训练难度',
        jsonPath: 'flag/100',
    ...
    EditorItem(
      ...
      dataType: DataType.int,
      layoutType: LayoutType.double,
      description: '极端行为的爱慕阈值倍率（越高越容易施行）',
    ),
    EditorItem(
      label: '回合声望变化',
      jsonPath: 'flag/111',
    ...
    EditorItem(
      ...
      dataType: DataType.choice,
      choices: [
        EditorChoice(-25, "相看相厌"),
        EditorChoice(0, "君子之交"),
        EditorChoice(10, "愈久愈和"),
      ],
      layoutType: LayoutType.double,
    ...
    EditorItem(
      ...
      choices: [
        EditorChoice(0, "否"),
        EditorChoice(1, "地下室逃出失败"),
        EditorChoice(2, "马娘评分太低被极端粉丝袭击"),
      ],
      layoutType: LayoutType.double,
      description: '是否会触发Game Over',
    ),
    EditorItem(
        label: '强奸抵抗',
        jsonPath: 'flag/122',
        dataType: DataType.boolean,
        layoutType: LayoutType.double,
        description: '雷普马娘需要经过力量对抗且雷普时马娘不会自动发情'),
    EditorItem(
        label: '不伦之恋',
        jsonPath: 'flag/115',
        dataType: DataType.boolean,
    ...
    EditorItem(
      ...
      layoutType: LayoutType.double,
      description: '出场角色性别，不影响弗隆K、弗隆P和主角性别',
    ),
    EditorItem(
      label: '变态行为',
      jsonPath: 'flag/36',
